...
namespace Homework2
{
    class Program
    {
        ...
        {
            Console.WriteLine("Program to record hours of activity");
        ...
        static string yourtype()
        {
            ...
            if (t == 1)
            {   informationStudent(); Console.Clear(); Login();   }
            else if (t == 2)
            {   informationEmployee(); Console.Clear(); Login();   }
        ...
        {   Console.Write("Name : "); return Console.ReadLine();   }

        static string yourpassword()
        {   Console.Write("Password : "); return Console.ReadLine();   }

        static string informationStudent()
        {   Console.Write("Student ID : "); return Console.ReadLine();   }
        ...
        {   Console.Write("Employee ID : "); return Console.ReadLine();   }
        ...
        static void Login()
        {
            ...
            if (ty == 1)
            {   Console.WriteLine("Accouct Check Activity Hours For Student"); Activity();   }
            if (ty == 2)
            {   Console.WriteLine("Accouct Check Activity Hours For Employee"); Activity();   }
    ...
    class Person
    {
        public string name; public string password; public string type;
    ...
    {   public string name; public string password; public string StudentID; public string type;
    ...
    {   public string name; public string password; public string EmployeeID; public string type;
